...
const Header: React.FunctionComponent<{
    ...
    return (
        <header
            className={`${darkMode ? 'bg-taco-background-dark' : 'bg-white'} rounded-b-xl py-2.5 flex justify-between items-center w-full`}>
            <title>{title}</title>
            <TacoLogo/>
