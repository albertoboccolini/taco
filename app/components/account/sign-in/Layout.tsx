...
const Layout: NextPage = () => {
    ...
    const {updateEmail, email, visiblePassword, password, updatePassword, togglePasswordVisibility, authenticate} = Engine();
                    ...
                    <div className="mx-auto max-w-md space-y-8">
                        <div
                            ...
                            <p className="text-center text-sm text-gray-400">
                                Please enter your e-mail and password so we can verify everything is good and we can back work together.
                            </p>
