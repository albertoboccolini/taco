...
const Layout: React.FC = () => {
    ...
    const tools = [
        ...
        {logo: tacoPasswordsLogo, toolLink: "/tools/passwords", toolName: "taco passwords", category: "other"},
        {logo: tacoPaletteLogo, toolLink: "/tools/palette", toolName: "taco palette", category: "generator"},
        {logo: tacoDropLogo, toolLink: "/tools/drop", toolName: "taco drop", category: "generator"},
